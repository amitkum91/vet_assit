# Generated by Django 4.2.10 on 2024-03-09 04:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pet_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core_app.pet_registration')),
            ],
        ),
        migrations.CreateModel(
            name='appointment',
            fields=[
                ...
                ('doc_id', models.ForeignKey(db_column='doc_id', on_delete=django.db.models.deletion.CASCADE, to='core_app.doctor_reg')),
                ('pet_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core_app.pet_details')),
                ('pet_owner_id', models.ForeignKey(db_column='cust_id', on_delete=django.db.models.deletion.CASCADE, to='core_app.cust_login_registration')),
            ],
        ),
    ]
